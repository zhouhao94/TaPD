...
class Trainer(pl.LightningModule):
    ...
    def training_step(self, data_list, batch_idx):
        ...
        self.net.features_dict.clear()   # 对应模型保存的特征字典
        ...
        for (student_start, student_end), (teacher_start, teacher_end) in self.alignment_pairs.items():
            student_feat = self.net.features_dict.get((student_start, student_end))
            teacher_feat = self.net.features_dict.get((teacher_start, teacher_end))
